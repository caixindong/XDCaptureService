...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/458770054@qq.com/XDCaptureService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '458770054@qq.com' => 'danecai@webank.com' }
  s.source           = { :git => 'https://github.com/458770054@qq.com/XDCaptureService.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'XDCaptureService' => ['XDCaptureService/Assets/*.png']
  # }
